...
class BillingUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            context["last_billing"] = (
                context["sale"].billings.all().order_by("payment_date").reverse()[1]
            )
        except IndexError:
            pass
        return context
    ...
    def get_success_url(self):
        # to retrieve last bill amount for update
        # instead of current bill
        # by seting actual bill to temporary
        self.object.is_temporary = True
        self.object.save()
