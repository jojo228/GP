...
class CustomerDeleteView(AdminStaffRequiredMixin, DeleteView):
    model = Customer
    success_url = reverse_lazy("list_customer")
    template_name = "marine/customer/customer_confirm_delete.html"

    def delete(self, *args, **kwargs):
        try:
            return super(CustomerDeleteView, self).delete(*args, **kwargs)
