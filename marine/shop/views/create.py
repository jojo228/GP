...
from marine.shop.forms import ShopForm
from marine.shop.models import Shop
from marine.views import SuperUserRequiredMixin


class ShopCreateView(SuperUserRequiredMixin, CreateView):
    form_class = ShopForm
    template_name = "marine/shop/shop_create.html"
    ...
    def get_success_url(self):
        return reverse("detail_shop", kwargs={"pk": self.object.pk})
