...
class ShopDeleteView(SuperUserRequiredMixin, DeleteView):
    model = Shop
    success_url = reverse_lazy("list_shop")
    template_name = "marine/shop/shop_confirm_delete.html"

    def delete(self, *args, **kwargs):
        try:
            return super(ShopDeleteView, self).delete(*args, **kwargs)
