...
class SupplierDeleteView(AdminStaffRequiredMixin, DeleteView):
    model = Supplier
    success_url = reverse_lazy("list_supplier")
    template_name = "marine/supplier/supplier_confirm_delete.html"

    def delete(self, *args, **kwargs):
        try:
            return super(SupplierDeleteView, self).delete(*args, **kwargs)
