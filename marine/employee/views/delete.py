...
class EmployeeDeleteView(AdminStaffRequiredMixin, DeleteView):
    model = Employee
    success_url = reverse_lazy("list_employee")
    template_name = "marine/employee/employee_confirm_delete.html"

    def delete(self, *args, **kwargs):
        try:
            return super(EmployeeDeleteView, self).delete(*args, **kwargs)
