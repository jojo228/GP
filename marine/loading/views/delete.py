...
class LoadingDeleteView(AdminStaffRequiredMixin, DeleteView):
    model = Loading
    success_url = reverse_lazy("list_loading")
    template_name = "marine/loading/loading_confirm_delete.html"
