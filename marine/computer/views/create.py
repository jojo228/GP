...
from marine.computer.forms import ComputerForm
...
class ComputerCreateView(SuperUserRequiredMixin, CreateView):
    form_class = ComputerForm
    template_name = "marine/computer/computer_create.html"

    def get_queryset(self):
        keyword = self.request.GET.get("search")
        object_list = Computer.objects.all()
        if keyword:
    ...
    def get_success_url(self):
        return reverse("detail_computer", kwargs={"pk": self.object.pk})
